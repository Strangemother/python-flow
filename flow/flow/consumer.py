#!c:\users\jay\documents\projects\state-machine\env\scripts\python.exe
...
def consumer_main(huey_instance=None):
...
def consumer_default_main():
    path = 'flow.machine.main.huey'
    print(f'Executing default machine: {path}')
    return consumer_main(path)
